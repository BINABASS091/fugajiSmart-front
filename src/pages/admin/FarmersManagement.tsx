  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] animate-pulse">
        ...
        <p className="text-gray-400 font-black uppercase tracking-widest text-sm">Loading user data...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4 border-b border-gray-100">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">User Management</span>
          </div>
          <h1 className="text-5xl font-black text-gray-900 tracking-tighter uppercase leading-none">
            User <span className="text-gray-400">Directory</span>
          </h1>
          <p className="text-gray-500 font-bold text-lg leading-relaxed">Manage and verify user accounts and permissions.</p>
        </div>
        <div className="flex items-center gap-4">
          <Card className="px-6 py-4 bg-white border border-gray-100 rounded-2xl shadow-sm flex items-center gap-4">
            <div className="flex flex-col items-end">
              <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Total Users</span>
              <span className="text-xl font-black text-gray-900">{farmers.length} Users</span>
            </div>
            <div className="w-px h-8 bg-gray-100"></div>
            <div className="flex flex-col items-end">
              <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Pending Verification</span>
              <span className="text-xl font-black text-emerald-600">{farmers.filter(f => f.verification_status === 'PENDING').length} Users</span>
            </div>
          </Card>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-50">
                <th className="px-10 py-8 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">User Name</th>
                <th className="px-10 py-8 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">Business Name</th>
                <th className="px-10 py-8 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">Location</th>
                <th className="px-10 py-8 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">Experience</th>
                <th className="px-10 py-8 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">Verification Status</th>
                  ...
                  <tr key={farmer.id} className="group hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-10 py-8">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-black text-gray-700 uppercase tracking-tighter">{farmer.business_name || 'No Business'}</span>
                      </div>
                    </td>
                    <td className="px-10 py-8">
                      <div className="flex items-center gap-2">
                        <MapPin className="w-3.5 h-3.5 text-indigo-400" />
                        <span className="text-sm font-bold text-gray-600 uppercase tracking-tight">{farmer.location || 'No Location'}</span>
                      </div>
                    </td>
                    <td className="px-10 py-8">
                      <div className="flex items-center gap-2">
                        <Award className="w-3.5 h-3.5 text-amber-400" />
                        <span className="text-sm font-black text-gray-800">{farmer.experience_years} Years</span>
                      </div>
                    </td>
                    <td className="px-10 py-8">
